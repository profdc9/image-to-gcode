...
def rad1(x1,y1,x2,y2,x3,y3):
    ...
    if abs(den) < 1e-5: return 9223372036854775807
...
"""
    ...
    worst_dist = 0
    worst = 0
    min_rad = 9223372036854775807 # sys.maxint
    max_arc = -1
    ...
    worst_arc_dist = 0
    if min_rad != 9223372036854775807:
        ...
        if one_quadrant(plane, (c1, c2), ps, st[max_arc], pe):
            ...
            worst_arc_dist = 9223372036854775807

    else:
        worst_arc_dist = 9223372036854775807

    #if worst_arc_dist != 9223372036854775807:
